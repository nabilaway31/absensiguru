<header class="bg-white shadow-sm border-b border-gray-200">
        ...
        <div class="flex items-center justify-between">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    @yield('page-subtitle', 'Sistem Manajemen Absensi Guru')
                </p>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative">
                    <button id="user-btn" type="button"
                        ...
                        <!-- chevron with transform/transition and id for toggling rotation -->
                    ...
                    <!-- Dropdown: tambahkan transition/transform classes -->
                    <div id="user-menu"
    ...
    <script>
        // Toggle dengan animasi: fade+scale + rotate chevron
        ...
        // close helper for outside clicks (also reset chevron)
        ...
        // close dropdown when clicking outside (gunakan closeUserMenu untuk animasi)
