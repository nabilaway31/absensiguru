<aside class="w-64 bg-slate-800 shadow-2xl">
    <div class="flex flex-col h-screen">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <a href="/settings"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 {{ request()->is('settings*') ? 'bg-white/10 text-white shadow-lg' : 'text-indigo-200 hover:bg-white/5 hover:text-white' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
